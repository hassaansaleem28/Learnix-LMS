...
const AllCourses: FC<Props> = ({}) => {
    ...
    function () {
      ...
      if (deleteError) {
        if ("data" in deleteError) {
          const msg =
            (deleteError.data as any)?.message || "Failed to delete course";
          toast.error(msg);
        } else {
          toast.error(
            (deleteError as any)?.message || "Failed to delete course"
          );
        }
      }
    },
  ...
  async function handleDelete() {
    ...
    if (deleteSuccess) setOpen(false);
  }
